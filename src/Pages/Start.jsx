    ...
    <div className="transparent">
      <div className="start-page-column transparent">
        <div className="banner mt">
          <h1 className="start-title text-div transparent">
            {t("welcome.title")}
            <span className="orbitron-font white-color transparent">
              {t("welcome.title2")}
            </span>
          </h1>
          <p className="start-subtitle transparent">
        ...
        <Link to="report" className="start-card card-fx">
          <IconReport size={140} stroke={1} className="start-card-bg" />
        ...
        <Link to="timer" className="start-card card-fx">
          <IconTimeDuration15 size={140} stroke={1} className="start-card-bg" />
          <div className="text-div">
        ...
        <Link to="/edit" className="start-card card-fx">
          <IconCashEdit size={140} stroke={1} className="start-card-bg" />
          <div className="text-div">
        ...
        <Link to="history" className="start-card card-fx">
          <IconHistory size={140} stroke={1} className="start-card-bg" />
          <div className="text-div">
        ...
        <Link to="weightLog" className="start-card card-fx">
          <IconScaleOutline size={140} stroke={1} className="start-card-bg" />
          <div className="text-div">
        ...
        <Link to="exportImport" className="start-card card-fx">
          <IconDatabaseExport size={140} stroke={1} className="start-card-bg" />
          <div className="text-div">
